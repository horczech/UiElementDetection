...
def generate_tfrecords(annotation_dir_path, image_dir_path, labelmap_path, output_file):
...
if __name__ == '__main__':
    ...
    ANNOTATION_DIR_PATH = r"C:\Code\Dataset2\annotations\printer\phase_2\test"
    OUTPUT_FILE_PATH = r"C:\Code\Dataset2\annotations\mixed\test_denoised_printer.record"
